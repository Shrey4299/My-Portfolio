  ...
  return (
    ...
    <div className="flex flex-col md:flex-row gap-5    md:gap-[15%]  ">
      ...
      <div className="cn">
        ...
        <p className='text-slate-300 text-center md:text-left mb-7'>Creative Full-stack Web Developer providing high-impact web solutions for diverse industry organizations.
